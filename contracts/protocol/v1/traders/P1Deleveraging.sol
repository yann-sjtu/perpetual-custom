 ...
 */
contract P1Deleveraging is Ownable, P1TraderConstants {
    ...
    constructor(address perpetualV1, address deleveragingOperator) public {
    ...
    function trade(
        ...
        P1Types.Balance memory takerBalance = P1Getters(perpetual)
    ...
    function _isUnderwater(P1Types.Balance memory balance, uint256 price)
        private
        pure
        returns (bool)
    {
    ...
    function _isAccountUnderwater(address account) private view returns (bool) {
        address perpetual = _PERPETUAL_V1_;
        P1Types.Balance memory balance = P1Getters(perpetual).getAccountBalance(
            account
        );
