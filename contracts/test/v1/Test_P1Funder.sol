...
contract Test_P1Funder is I_P1Funder {
    ...
    function setFundingRate(SignedMath.Int calldata newRate) external {
        _FUNDING_IS_POSITIVE_ = newRate.isPositive;
        _FUNDING_ = newRate.value;
    }
}
